...
GIOCATORI ISCRITTI: <c:out value="${giocatori.size()}"/>
<table class="table table-striped">
    				<thead>
						<tr>
						  <th>Nome</th>
    		...
    		<div class="jumbotron">
    			<table class="table table-striped">
    				...
    				<tbody>
    					...
    					<!-- rimuovo il pulsante per accedere alle partite da parte del giocatore: -->
						...
						-->
    						...
    						<tr>
    							...
    							<td><c:out value="${partita.set3.getRisultato()}"/></td>
	 							<c:if  test="${partita.set1.getRisultato() != null or partita.forfait}" >
